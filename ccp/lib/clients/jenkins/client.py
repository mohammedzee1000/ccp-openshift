...
class OpenshiftJenkinsWorkflowAPIClient(OpenshiftJenkinsBaseAPIClient):
    ...
    def get_run_artifacts(self, job_ordered_list, build_number):
        """
        Gets the artifacts generated by the build run, if any
        :param job_ordered_list: The ordered list of jobs, with parents,
        followed by children
        :param build_number: The number of the build.
        :return: The response from API server, if it was recieved
        """
        return self._query(
            "{}/{}/wfapi/artifacts".format(
                self._jenkins_jobs_from_jobs_ordered_list(job_ordered_list),
                build_number
            )
        )

    def get_run_pending_actions(self, job_ordered_list, build_number):
        """
        Gets the pending actions, if any
        :param job_ordered_list: 
        :param build_number:
        :return:
        """
